...
class _AddNewAppartmentScreenState
  ...
  void _addApartmentToDataBase() async {
    ...
    if (data['success'] == true) {
      ...
      String errorMessage = data['errors'].toString();
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildMultiLineTextField(
                  'Description',
                  hint: 'Detail all features and amenities',
                ...
                _buildDropdownField<String>(
                  ...
                  items: _selectedCity != null
                      ? (_stateOptionsMap[_selectedCity] ?? [])
                      : [],
                  onChanged: (newValue) =>
                ...
                _buildTextField(
                  'Address (Major Area)',
                  hint: 'Enter street name or major landmark',
  ...
  AppBar _buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        widget.isEditing ? 'Edit Apartment' : 'Add new appartment',
